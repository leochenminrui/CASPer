...
OUT=ROOT/'results/final_experiments/shap'; OUT.mkdir(parents=True,exist_ok=True)
MODELS={
...
def main():
    ...
    for rep,(mid,fkey,kwargs) in MODELS.items():
      ...
      for seed in range(5):
        p=ROOT/f'results/final_experiments/raw_runs/primary_ablation/random/seed_{seed}/{mid}/best_params.json'
